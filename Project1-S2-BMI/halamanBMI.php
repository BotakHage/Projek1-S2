        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="https://kreasi.nurulfikri.ac.id/ahma21280ti/Praktikum%2001/" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 01</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="https://kreasi.nurulfikri.ac.id/ahma21280ti/Praktikum%2002/" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 02</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="https://kreasi.nurulfikri.ac.id/ahma21280ti/Praktikum%2003/" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 03</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="https://kreasi.nurulfikri.ac.id/ahma21280ti/Praktikum%2004/" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 04 </p>
                </a>
              </li>
...
<h1 align='center' style="background-color:cornflowerblue;color: white;"><b>Hasil BMI</b></h1>
<table class="table table-hover">
  <thead>
    <tr>
